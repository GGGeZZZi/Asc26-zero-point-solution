...
##
##################################################################
## 脱敏版说明：此文件已检查并确认不含机器特定路径、CUDA版本后缀、
## CPU型号优化或本地包路径等敏感信息。所有路径均通过输入参数动态获取，
## 符合ASC26数据敏感要求。实际使用时请确保输入文件AMSS_NCKU_Input.py
## 同样经过脱敏处理。
##################################################################
...
if os.path.exists(File_directory):
    ...
    print( " simulation. Then you can reset the output directory in the input script file AMSS_NCKU_Input.py !!! " )
    print(                                                                                                          )
